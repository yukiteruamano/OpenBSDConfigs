...
require'nvim-treesitter.configs'.setup({
  ...
  highlight = {
    ...
    -- disable highlighting for the `tex` filetype, you need to include `latex` 
...
-- LuaSnip using VSCode like snippets
...
require('lualine').setup({
  ...
  sections = {
    lualine_a = {'mode'},
    lualine_b = {'branch', 'diff', 'diagnostics', 'lsp'},
    lualine_c = {'filename'},
